...
- Pure-integer nanometre arithmetic end to end, because unit confusion between
  ...
  of bug
- 203 tests that run with no network, no API key, and no KiCad installed
...
- **203 tests, and the interesting ones are regressions** — each pins down a specific bug
...
excluded from lint and tests, and it contributes nothing to the 203 tests or to
