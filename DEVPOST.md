...
- Pure-integer nanometre arithmetic end to end, because unit confusion between
  ...
  of bug
- 467 tests that run with no network, no API key, and no KiCad installed
...
- **467 tests, and the interesting ones are regressions** — each pins down a specific bug
...
excluded from lint and tests, and it contributes nothing to the 467 tests or to
