...
- Pure-integer nanometre arithmetic end to end, because unit confusion between
  ...
  of bug
- 948 tests that run with no network, no API key, and no KiCad installed
...
- **948 tests, and the interesting ones are regressions** — each pins down a specific bug
...
excluded from lint and tests, and it contributes nothing to the 948 tests or to
