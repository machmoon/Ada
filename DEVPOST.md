...
- Pure-integer nanometre arithmetic end to end, because unit confusion between
  ...
  of bug
- 741 tests that run with no network, no API key, and no KiCad installed
...
- **741 tests, and the interesting ones are regressions** — each pins down a specific bug
...
excluded from lint and tests, and it contributes nothing to the 741 tests or to
