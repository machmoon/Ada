...
```
741 tests collected — no network, no API key, no KiCad install
```
...
| Testable without KiCad | No | **Yes, all 741 tests** |
...
engine/
  ...
  tests/          741 tests — no network, no API keys, no KiCad
...
**1. Test suite** — 741 tests (live-model and local-simulator cases skip when
