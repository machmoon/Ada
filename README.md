...
```
1352 tests collected — no network, no API key, no KiCad install
```
...
| Testable without KiCad | No | **Yes, all 1352 tests** |
...
engine/
  ...
  tests/          1352 tests — no network, no API keys, no KiCad
