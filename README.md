...
```
811 tests collected — no network, no API key, no KiCad install
```
...
| `constraints/` — datasheet PDF → checkable, provenance-carrying constraints | **Working** · 93 tests |
...
| Testable without KiCad | No | **Yes, all 811 tests** |
...
engine/
  ...
  tests/          811 tests — no network, no API keys, no KiCad
...
**1. Test suite** — 811 tests (live-model and local-simulator cases skip when
