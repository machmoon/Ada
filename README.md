...
```
1084 tests collected — no network, no API key, no KiCad install
```
...
| Testable without KiCad | No | **Yes, all 1084 tests** |
...
engine/
  ...
  tests/          1084 tests — no network, no API keys, no KiCad
