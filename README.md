...
```
1013 tests collected — no network, no API key, no KiCad install
```
...
| Testable without KiCad | No | **Yes, all 1013 tests** |
...
engine/
  ...
  tests/          1013 tests — no network, no API keys, no KiCad
