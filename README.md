...
```
1004 tests collected — no network, no API key, no KiCad install
```
...
| Testable without KiCad | No | **Yes, all 1004 tests** |
...
engine/
  ...
  tests/          1004 tests — no network, no API keys, no KiCad
